...
/**
 * API route handler for generating SWOT strategies
...
export async function POST(request: NextRequest) {
  try {
    ...
    const response = await axios.post(
      ...
      {
        strengths: requestBody.strengths || [],
        weaknesses: requestBody.weaknesses || [],
        opportunities: requestBody.opportunities || [],
        threats: requestBody.threats || []
      },
      {
    ...
    return NextResponse.json(
      { 
        error: 'Đã xảy ra lỗi khi tạo chiến lược. Vui lòng thử lại sau.',
